...
if __name__ == '__main__':
    ...
    im = open('D:\Code\DarkCatPython\chaojiying_Python\\a.jpg', 'rb').read()													#本地图片文件路径 来替换 a.jpg 有时WIN系统须要//
    code = chaojiying.PostPic(im, 1902)												#1902 验证码类型  官方网站>>价格体系 3.4+版 print 后要加()
    print(code)
